...
void CBaseTFPlayer::FollowClientRagdoll( void )
{
	...
	UTIL_TraceHull( GetAbsOrigin() + Vector(0,0,18), GetAbsOrigin(), vecMin, vecMax, MASK_PLAYERSOLID, this, COLLISION_GROUP_NONE, &tr );
...
bool CBaseTFPlayer::CheckRagdollToStand( trace_t &trace )
{
	...
	UTIL_TraceHull( m_vecLastGoodRagdollPos + Vector( 0, 0, 18 ), m_vecLastGoodRagdollPos, vecMin, vecMax, MASK_PLAYERSOLID, this, COLLISION_GROUP_NONE, &trace );
