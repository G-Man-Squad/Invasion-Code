...
void CWeaponCombatBurstRifle::PrimaryAttack( void )
{
	...
	do 
	{
		...
		x1 = SharedRandomFloat( "burstrifleax1", -0.5, 0.5, ++seed);
		x2 = SharedRandomFloat( "burstrifleax2", -0.5, 0.5, ++seed );
		y1 = SharedRandomFloat( "burstrifleay1", -0.5, 0.5, ++seed );
		y2 = SharedRandomFloat( "burstrifleay2", -0.5, 0.5, ++seed );
...
{	
	...
	{
		float flFireRate = ( SequenceDuration() * 0.6f ) + RandomFloat( 0.0, 0.035f );
	...
	return RandomFloat( 0.075f, 0.15f );
}
