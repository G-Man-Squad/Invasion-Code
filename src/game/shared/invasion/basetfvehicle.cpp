...
//-----------------------------------------------------------------------------
void CBaseTFVehicle::RestorePassengerInfo( void )
{
	//STUB
}

void CBaseTFVehicle::ReloadScript()
{
	//STUB
}
...
//-----------------------------------------------------------------------------
bool CBaseTFVehicle::PassengerShouldReceiveDamage( CTakeDamageInfo &info )
{
	return true;
}
...
//-----------------------------------------------------------------------------
void CBaseTFVehicle::GetPassengerSeatPoint( int nRole, Vector *pPoint, QAngle *pAngles )
{
	//STUB
}
...
//-----------------------------------------------------------------------------
bool CBaseTFVehicle::NPC_AddPassenger( CBaseCombatCharacter *pPassenger, string_t strRoleName, int nSeat )
{
	return false;
}
...
//-----------------------------------------------------------------------------
bool CBaseTFVehicle::NPC_RemovePassenger( CBaseCombatCharacter *pPassenger )
{
	return false;
}
...
//-----------------------------------------------------------------------------
int CBaseTFVehicle::NPC_GetPassengerSeatAttachment( CBaseCombatCharacter *pPassenger )
{
	return -1;
}
...
//-----------------------------------------------------------------------------
bool CBaseTFVehicle::NPC_GetPassengerSeatPosition( CBaseCombatCharacter *pPassenger, Vector *vecResultPos, QAngle *vecResultAngles )
{
	return true;
}
...
// Input  : *pPassenger - Passenger's seat to use
//-----------------------------------------------------------------------------
bool CBaseTFVehicle::NPC_GetPassengerSeatPositionLocal( CBaseCombatCharacter *pPassenger, Vector *vecResultPos, QAngle *vecResultAngles )
{
	return true;
}
...
//-----------------------------------------------------------------------------
const PassengerSeatAnims_t * CBaseTFVehicle::NPC_GetPassengerSeatAnims( CBaseCombatCharacter *pPassenger, PassengerSeatAnimType_t nType )
{
	return NULL;
}

int CBaseTFVehicle::NPC_GetAvailableSeat( CBaseCombatCharacter* pPassenger, string_t strRoleName, VehicleSeatQuery_e nQueryType )
{
	return -1;
}

bool CBaseTFVehicle::NPC_HasAvailableSeat( string_t strRoleName )
{
	return ( NPC_GetAvailableSeat( NULL, strRoleName, VEHICLE_SEAT_ANY ) != -1 );
}

CBaseCombatCharacter * CBaseTFVehicle::NPC_GetPassengerInSeat( int nRoleID, int nSeatID )
{
	return NULL;
}
